...
SRC_URI = "git://source.codeaurora.org/external/imx/weston-imx.git;protocol=https;branch=${SRCBRANCH} \
           ...
           file://xwayland.weston-start \
           file://0001-weston-launch-Provide-a-default-version-that-doesn-t.patch \
	   file://0001-backend-drm-drm.c-Use-DRM_FORMAT_P010-with-v4.14-ker.patch \
	   file://0001-libweston-pixel-formats-Use-DRM_FORMAT_P010-on-v4.14.patch \
	   file://0001-backend-drm-drm-remove-hdr-metadata-for-v4.14.patch \
	   file://0001-backend-drm-state-propose-force-video-onto-DCSS-plan.patch \
"
